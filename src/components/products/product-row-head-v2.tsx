...
type ProductRowHeadV2Props = {
  product: Product;
  peopleMap: Map<PersonId, Person>;
};

// v2 head: bigger thumbnail (stretches to match the right block), inline-edit
// title on hover, and a stacked "right corner" carrying both the updated-by line
// and an editable due-date chip.
//
// Grid columns: 96px cover · 1fr title · auto right-corner.
// Items stretch so the cover image picks up the full body height.
export function ProductRowHeadV2({ product, peopleMap }: ProductRowHeadV2Props) {
