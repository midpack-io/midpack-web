...
- **Єдина точка сходження.** Кожне outbound посилання з Midpack веде сюди. Інші сторінки рольові; ця — спільна.
...
- **Canonical URL:** `https://app.midpack.app/bundles/{id}` — це той URL, що Марта копіює.
- **Inbound traffic:**
...
1. Марта клікає Slack-посилання `https://app.midpack.app/bundles/abc123` о 9:14.
...
2. URL `https://app.midpack.app/bundles/abc123` копіюється у clipboard. Toast: "Bundle URL copied".
